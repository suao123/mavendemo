...
<html>
    ...
    <body class="mdui-appbar-with-toolbar mdui-drawer-body-left">
			...
			<div class="mdui-list" mdui-collapse="{accordion: true}" style="margin-bottom: 76px;">
				...
				<div class="mdui-collapse-item  mdui-collapse-item-open">
					...
					<div class="mdui-collapse-item-body mdui-list">
						...
						<a style="font-size: 15px; background-color: rgba(0, 0, 0, .1);" href="myAdvertisement" class="mdui-list-item mdui-ripple ">我的广告位</a>
					</div>
				</div>
		...
		<div class="mdui-container-fluid" style="height: 100%; width:100%; ">
			<h2 style="margin-top:3%; text-align: center;">我的广告位</h2>
				...
				<div class="mdui-table-fluid">
					<table class="mdui-table mdui-table-hoverable">
						...
						<tr>
							...
							<td>市场标书首页</td>
							<td>15天</td>
							<td><button class="mdui-btn mdui-color-pink-400">前往编辑</button></td>
						</tr>
