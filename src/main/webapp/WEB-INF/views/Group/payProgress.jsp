...
<html>
    ...
    <body class="mdui-appbar-with-toolbar mdui-drawer-body-left">
			...
			<div class="mdui-list" mdui-collapse="{accordion: true}" style="margin-bottom: 76px;">
				...
				<div class="mdui-collapse-item  mdui-collapse-item-open">
					...
					<div class="mdui-collapse-item-body mdui-list" style="">
						...
						<a style="font-size: 15px; background-color: rgba(0, 0, 0, .1);" href="payProgress" class="mdui-list-item mdui-ripple ">报酬进度查看</a>
					</div>
				</div>
				...
				<div class="mdui-collapse-item" >
					...
					<div class="mdui-collapse-item-body mdui-list">
						...
						<a style="font-size: 15px; " href="#" class="mdui-list-item mdui-ripple "><span style="position: absolute; left: 14%; background: #FF0000; color: #FFFFFF; border-radius: 25px; width: 22px; height: 22px; text-align: center; margin-right: 1.25rem; text-align: center;display: flex; align-items: center;justify-content: center;">1</span>系统公告</a>
					</div>
				</div>
		...
		<div id="" style="margin-left: 1%;">
			<h2 style="text-align: center; margin-top: 3%;">支付进度</h2>
