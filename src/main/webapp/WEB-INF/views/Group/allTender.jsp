			...
			<div class="mdui-list" mdui-collapse="{accordion: true}" style="margin-bottom: 76px;">
				...
				<div class="mdui-collapse-item mdui-collapse-item-open">
					<div class="mdui-collapse-item-header mdui-list-item mdui-ripple">
						...
						<div class="mdui-collapse-item-body mdui-list" style="">
							<a style="font-size: 15px; background-color: rgba(0, 0, 0, .1);" href="allTender" class="mdui-list-item mdui-ripple ">市场招标书</a>
				...
				<div class="mdui-collapse-item">
					...
					<div class="mdui-collapse-item-body mdui-list">
						<a style="font-size: 15px;" href="email" class="mdui-list-item mdui-ripple "><span style="position: absolute; left: 14%; background: #FF0000; color: #FFFFFF; border-radius: 25px; width: 22px; height: 22px; text-align: center; margin-right: 1.25rem; text-align: center;display: flex; align-items: center;justify-content: center;">2</span>收到的邮箱</a>
						<a style="font-size: 15px;" href="announcement" class="mdui-list-item mdui-ripple "><span style="position: absolute; left: 14%; background: #FF0000; color: #FFFFFF; border-radius: 25px; width: 22px; height: 22px; text-align: center; margin-right: 1.25rem; text-align: center;display: flex; align-items: center;justify-content: center;">2</span>系统公告</a>
					</div>
				</div>
				
			</div>
		</div>
		<h2 style="margin-bottom:1%;margin-top: 1%; text-align: center;">市场招标书列表</h2>
		<!-- 广告插入 -->
		<div class="box" id = "box">
			<div class="inner" id = "inner">
				<ul id="ul1">
					...
					<li><a href="#"><img src="/static/img/4.jpg" alt=""></a></li>
					<li><a href="#"><img src="/static/img/3.jpg" alt=""></a></li>
				...
				<div class="mdui-table-fluid">
					<table class="mdui-table mdui-table-hoverable">
						...
						<tr>
							...
							<td>2019-4-19</td>
							<td>2019-4-25</td>
							<td><a mdui-tooltip="{content: '查看投标人'}" style="text-decoration: none;" href="#"><i style="margin-right: 7px;" class="mdui-icon material-icons">person</i>15</a></td>
							<th><a mdui-tooltip="{content: '查看该企业'}" style="text-decoration: none;" href="#"><i style="margin-right: 7px;" class="mdui-icon material-icons">group</i>临安运政</a></th>
							<td> <button class="mdui-btn mdui-color-pink-400" onclick="details(${product.agId})">标书详情</button> </td>
						</tr>
						...
						<tr>
							...
							<td>2019-4-29</td>
							<td>2019-5-4</td>
							<td><a mdui-tooltip="{content: '查看投标人'}" style="text-decoration: none;" href="#"><i style="margin-right: 7px;" class="mdui-icon material-icons">person</i>8</a></td>
							<th><a mdui-tooltip="{content: '查看该企业'}" style="text-decoration: none;" href="#"><i style="margin-right: 7px;" class="mdui-icon material-icons">group</i>临安运政</a></th>
							<td> <button class="mdui-btn mdui-color-pink-400" onclick="details(${product.agId})">标书详情</button> </td>
						</tr>
						...
						<tr>
							...
							<td>2019-5-4</td>
							<td><a mdui-tooltip="{content: '查看投标人'}" style="text-decoration: none;" href="#"><i style="margin-right: 7px;" class="mdui-icon material-icons">person</i>8</a></td>
							<th><a mdui-tooltip="{content: '查看该企业'}" style="text-decoration: none;" href="#"><i style="margin-right: 7px;" class="mdui-icon material-icons">group</i>临安花魂有限公司</a></th>
							<td> <button class="mdui-btn mdui-color-pink-400" onclick="details(${product.agId})">标书详情</button> </td>
						</tr>
						...
						<tr>
							...
							<td>2019-5-4</td>
							<td><a mdui-tooltip="{content: '查看投标人'}" style="text-decoration: none;" href="#"><i style="margin-right: 7px;" class="mdui-icon material-icons">person</i>8</a></td>
							<th><a mdui-tooltip="{content: '查看该企业'}" style="text-decoration: none;" href="#"><i style="margin-right: 7px;" class="mdui-icon material-icons">group</i>杭州网易云</a></th>
							<td> <button class="mdui-btn mdui-color-pink-400" onclick="details(${product.agId})">标书详情</button> </td>
						</tr>
						...
						<tr>
							...
							<td>2019-5-4</td>
							<td><a mdui-tooltip="{content: '查看投标人'}" style="text-decoration: none;" href="#"><i style="margin-right: 7px;" class="mdui-icon material-icons">person</i>8</a></td>
							<th><a mdui-tooltip="{content: '查看该企业'}" style="text-decoration: none;" href="#"><i style="margin-right: 7px;" class="mdui-icon material-icons">group</i>企鹅电竞</a></th>
							<td> <button class="mdui-btn mdui-color-pink-400" onclick="details(${product.agId})">标书详情</button> </td>
						</tr>
