				...
				<div class="mdui-collapse-item mdui-collapse-item-open">
					<div class="mdui-collapse-item-header mdui-list-item mdui-ripple">
						...
						<div class="mdui-collapse-item-body mdui-list" style="">
							...
							<a style="font-size: 15px; background-color: rgba(0, 0, 0, .1);" href="tenderRecord" class="mdui-list-item mdui-ripple ">能力等级查询</a>
						</div>
				</div>
			...
			<div class="mdui-panel" mdui-panel>
				<div class="mdui-panel-item">
				    <div class="mdui-panel-item-header">
						...
						<div style="width: 25%; min-width: 25%; font-weight: 700;" class="mdui-panel-item-title">发布企业</div>
		    ...
		    <div class="mdui-panel" mdui-panel>
				<div class="mdui-panel-item">
				    <div class="mdui-panel-item-header">
						...
						<div id="sty" mdui-tooltip="{content: '查看企业'}" style="width: 25%; min-width: 25%; font-weight: 500;" class="mdui-text-color-blue-500 mdui-panel-item-title"><a href="#" style="text-decoration: none;font-size: 110%;"><i style="margin-right: 7px;" class="mdui-icon material-icons">group</i>临安花魂</a></div>
				...
				<div class="mdui-panel-item">
				    <div class="mdui-panel-item-header">
						...
						<div id="sty" mdui-tooltip="{content: '查看团队'}" style="width: 25%; min-width: 25%; font-weight: 500;" class="mdui-text-color-blue-500 mdui-panel-item-title"><a href="#" style="text-decoration: none;font-size: 110%;"><i style="margin-right: 7px;" class="mdui-icon material-icons">group</i>临安标书有限公司</a></div>
						<div style="width: 25%; min-width: 25%; font-weight: 500;" class="mdui-panel-item-title ">完成</div>
				...
				<div class="mdui-panel-item">
				    <div class="mdui-panel-item-header">
						...
						<div id="sty" mdui-tooltip="{content: '查看团队'}" style="width: 25%; min-width: 25%; font-weight: 500;" class="mdui-text-color-blue-500 mdui-panel-item-title"><a href="#" style="text-decoration: none;font-size: 110%;"><i style="margin-right: 7px;" class="mdui-icon material-icons">group</i>杭州电子有限公司</a></div>
			...
			<div class="mdui-panel mdui-center" mdui-panel style="margin-top: 8%;">
				<div class="mdui-panel-item">
				    <div class="mdui-panel-item-header">
						...
						<button class="mdui-btn mdui-ripple mdui-color-pink-accent">能力提升申请</button>
				    </div>
				</div>
			</div>
			<br>
