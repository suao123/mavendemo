...
<html>
    ...
    <body class="mdui-appbar-with-toolbar mdui-drawer-body-left">
		...
		<div class="mdui-drawer mdui-drawer-open mdui-shadow-2" id="main-drawer" >
			<div class="mdui-list" mdui-collapse="{accordion: true}" style="margin-bottom: 76px;">
				...
				<div class="mdui-collapse-item mdui-collapse-item-open" >
					...
					<div class="mdui-collapse-item-body mdui-list">
						<a style="font-size: 15px; background-color: rgba(0, 0, 0, .1);" href="#" class=" mdui-list-item mdui-ripple "><span style=" position: absolute; left: 14%; background: #FF0000; color: #FFFFFF; border-radius: 25px; width: 22px; height: 22px; text-align: center; margin-right: 1.25rem; text-align: center;display: flex; align-items: center;justify-content: center;">3</span>收到的邮箱</a>
		...
		<div class="mdui-container-fluid" style="height: 100%; width:100%; ">
			<h2 style="margin-top:3%; text-align: center;">邮箱</h2>
			<div class="mdui-container" style="margin-top: 4%;">
				<div class="mdui-table-fluid">
					<table class="mdui-table mdui-table-hoverable">
						...
						<!-- 模板一 -->
						<tr>
							<td><a mdui-tooltip="{content: '查看联系人'}" style="text-decoration: none;" href="#"><i style="margin-right: 7px;" class="mdui-icon material-icons">person</i>东湖神兽</a></td>
							<td>广告位购买成功通知</td>
							<td>2019-4-25</td>
						...
						<!-- 模板二 -->
						<tr>
							<td><a mdui-tooltip="{content: '查看联系人'}" style="text-decoration: none;" href="#"><i style="margin-right: 7px;" class="mdui-icon material-icons">person</i>来投标呀</a></td>
							<td>诚邀贵工作室来竞标</td>
							<td>2019-5-4</td>
							<td> <button class="mdui-btn mdui-color-pink-400" onclick="details(${product.agId})">查看</button> </td>
						</tr>
						...
						<!-- 模板三 -->
						<tr>
							<td><a mdui-tooltip="{content: '查看联系人'}" style="text-decoration: none;" href="#"><i style="margin-right: 7px;" class="mdui-icon material-icons">person</i>投标猎杀者</a></td>
							<td>诚邀贵工作室来竞标</td>
							<td>2019-5-4</td>
							<td> <button class="mdui-btn mdui-color-pink-400" onclick="details(${product.agId})">查看</button> </td>
						</tr>
