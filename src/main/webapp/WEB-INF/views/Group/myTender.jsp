...
<html>
    ...
    <body class="mdui-appbar-with-toolbar mdui-drawer-body-left">
				...
				<div class="mdui-collapse-item mdui-collapse-item-open">
					<div class="mdui-collapse-item-header mdui-list-item mdui-ripple">
						...
						<div class="mdui-collapse-item-body mdui-list" style="">
							...
							<a style="font-size: 15px; background-color: rgba(0, 0, 0, .1);" href="myTender" class="mdui-list-item mdui-ripple ">我的投标书</a>
						</div>
				</div>
		...
		<div class="mdui-container-fluid" style="height: 100%; width:100%; ">
			<h2 style="margin-top:3%; text-align: center;">我的投标书</h2>
