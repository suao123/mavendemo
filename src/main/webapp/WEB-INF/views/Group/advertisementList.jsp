...
<html>
    ...
    <body class="mdui-appbar-with-toolbar mdui-drawer-body-left">
			...
			<div class="mdui-list" mdui-collapse="{accordion: true}" style="margin-bottom: 76px;">
				...
				<div class="mdui-collapse-item  mdui-collapse-item-open">
					...
					<div class="mdui-collapse-item-body mdui-list">
						<a style="font-size: 15px; background-color: rgba(0, 0, 0, .1);" href="advertisementList" class="mdui-list-item mdui-ripple ">购买广告位</a>
		...
		<!-- 页面内容 -->
		<div class="mdui-container-fluid" style="height: 100%; width:90%; ">
			<h2 style="margin-top:3%; text-align: center;">广告位购买</h2>
				...
				<div class="mdui-table-fluid">
					<table class="mdui-table mdui-table-hoverable">
						...
						<tr>
							...
							<td>60000</td>
							<td>市场标书首页</td>
							<td><a href="payDetail2" class="mdui-btn mdui-color-pink-400">可购买</a></td>
						</tr>
						...
						<tr>
							...
							<td>65000</td>
							<td>市场标书首页</td>
							<td><a class="mdui-btn mdui-color-pink-400">可购买</a></td>
						</tr>
