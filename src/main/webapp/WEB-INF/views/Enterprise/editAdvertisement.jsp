    ...
    <body class="mdui-appbar-with-toolbar mdui-drawer-body-left">
		...
		<div class=" mdui-toolbar mdui-appbar mdui-appbar-fixed mdui-color-indigo ">
			<div class="mdui-toolbar mdui-color-theme">
				...
				<a href="login.html" style="margin-right: 0px;" class="mdui-btn mdui-color-light-blue-accent mdui-ripple">退出登录</a>
			</div>
		</div>
			...
			<div class="mdui-list" mdui-collapse="{accordion: true}" style="margin-bottom: 76px;">
				...
				<div class="mdui-collapse-item">
					<div class="mdui-collapse-item-header mdui-list-item mdui-ripple">
						...
						<div class="mdui-collapse-item-body mdui-list " style="">
							<a style="font-size: 15px;" href="messageShow.html" class="mdui-list-item mdui-ripple ">账号信息修改</a>
				...
				<div class="mdui-collapse-item ">
					<div class="mdui-collapse-item-header mdui-list-item mdui-ripple">
						...
						<div class="mdui-collapse-item-body mdui-list" style="">
							<a style="font-size: 15px;" href="editTender.html" class="mdui-list-item mdui-ripple ">发布招标</a>
							<a style="font-size: 15px;" href="myTender.html" class="mdui-list-item mdui-ripple ">我的招标书</a>
							<a style="font-size: 15px;" href="allTender.html" class="mdui-list-item mdui-ripple ">市场招标书</a>
						</div>
				</div>
				...
				<div class="mdui-collapse-item">
					...
					<div class="mdui-collapse-item-body mdui-list" style="">
						<a style="font-size: 15px;" href="tenderPay.html" class="mdui-list-item mdui-ripple ">招标书支付</a>
					</div>
				</div>
				...
				<div class="mdui-collapse-item">
					...
					<div class="mdui-collapse-item-body mdui-list" style="">
						<a style="font-size: 15px;" href="workProgress.html" class="mdui-list-item mdui-ripple ">工作进度查看</a>
						<a style="font-size: 15px;" href="payProgress.html" class="mdui-list-item mdui-ripple ">支付进度查看</a>
					</div>
				</div>
				...
				<div class="mdui-collapse-item">
					...
					<div class="mdui-collapse-item-body mdui-list" style="">
						<a style="font-size: 15px;" href="teamRanking.html" class="mdui-list-item mdui-ripple ">能力排行榜</a>
						<a style="font-size: 15px;" href="teamSearch.html" class="mdui-list-item mdui-ripple ">工作室搜索</a>
					</div>
				</div>
				...
				<div class="mdui-collapse-item mdui-collapse-item-open">
					...
					<div class="mdui-collapse-item-body mdui-list" style="">
						<a style="font-size: 15px;" href="advertisementList.html" class="mdui-list-item mdui-ripple ">购买广告位</a>
						<a style="font-size: 15px; background-color: rgba(0, 0, 0, .1);" href="#" class="mdui-list-item mdui-ripple ">发布广告信息</a>
						<a style="font-size: 15px;" href="myAdvertisement.html" class="mdui-list-item mdui-ripple ">我的广告位</a>
					</div>
				</div>
		...
		<div style="margin-top: 3%;">
			...
			<h2 style="text-align: center; margin-bottom: 3%;">发布广告</h2>
		
			<!-- 广告标题 -->
			<div class="mdui-textfield mdui-textfield-floating-label">
				<i class="mdui-icon material-icons" style="font-size: 18px; margin-left: 19%; color: black;"><span style="color: red;">*</span>广告标题:</i>
				<input id="name" name="name" onchange="nameCheck()" class="mdui-textfield-input" style="width:38% ; margin-left: 32%; font-size: 15px;" placeholder="请填写广告标题"></input>
			</div>
			<br>
			
			<!-- 标书名称 -->
			<div class="mdui-textfield mdui-textfield-floating-label">
				<i class="mdui-icon material-icons" style="font-size: 18px; margin-left: 19%; color: black;"><span style="color: red;">*</span>标书标题:</i>
				<input id="telephone" name="telephone" onchange="teleCheck()" class="mdui-textfield-input" style="width:38% ; margin-left: 32%; font-size: 15px;" placeholder="请输入标书的标题" ></input>
			...
			<!-- 海报图片 -->
			<div class="mdui-textfield mdui-textfield-floating-label">
				<i class="mdui-icon material-icons" style="font-size: 18px; margin-left: 19%;color: black;"><span style="color: red;">*</span>海报图片:</i>
			...
			<!-- 广告简介 -->
			<div>
				<i class="mdui-icon material-icons" style="padding:6px; font-size: 18px; margin-left: 19%;color: black;"><span style="color: red;">*</span>广告简介:</i>
			</div>
			<div>
				<textarea rows="10" cols="50" style="border:1px solid rgba(0, 0, 0, .42); margin-left: 32%;margin-top:-2%; width: 38%;" placeholder="请对广告进行简单的介绍";>
