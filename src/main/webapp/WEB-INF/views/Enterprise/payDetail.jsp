...
<html>
	...
	<div class="paying" style="margin-left: 3%; margin-right: 1%;">
		<p class="paytit" style="text-align: center;">
			...
			<strong style="padding-left: 2%; font-size: 120%;">需支付：<span>￥81291.00元</span></strong>
	...
	<div id="pay" >
		...
		<div style=" clear: left;float: left;margin-top: 5%; margin-left: 14%;">
			<div>
				...
				<a class="mdui-btn mdui-color-light-blue-800" style="margin-left: 25px;" href="tenderPay">返回上层</a>
				<br>
				<br>
				<br>
				<br>
