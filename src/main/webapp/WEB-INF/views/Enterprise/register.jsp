...
<html>
	...
	<div class="mdui-appbar">
		<div class="mdui-toolbar mdui-color-indigo">
			...
			<a  class="mdui-typo-title">企业用户注册</a>
	...
	<div id="register" class="mdui-shadow-11 mdui-color-white mdui-center" style="width: 55%;">
		<div class="mdui-container">
			<div class="mdui-tab mdui-tab-full-width" mdui-tab>
			    <a href="#" class="mdui-ripple">企业注册</a>
				<a href="Group/register" class="mdui-ripple">工作室注册</a>
			</div>
		</div>
		<br>
		...
		<div style="margin-left: 12%;">
			<div style="float: left;">
				<p style="font-size: 22px;font-weight: 400; border: 2px solid #E0E0E0; background-color: #0097A1; color: #FFFFFF; border-radius: 17px; width: 30px; height: 30px; text-align: center;display: flex; align-items: center;justify-content: center;">1</p>
			</div>
			<div style="float: left;">
				<p style="font-size: 22px;font-weight: 400; float: left; padding-top: 3.5%; padding-left: 4%; width: 140%;">联系人信息：</p>
			</div>
		</div>
		
		<!-- 公司名称 -->
		<div class="mdui-textfield mdui-textfield-floating-label" style="clear: left;">
			<i class="mdui-icon material-icons" style="font-size: 18px; margin-left: 12%; color: black"><span style="color: red;">*</span>公司名称:</i>
			<input id="companyName" name="companyName" onchange="comCheck()" class="mdui-textfield-input" style="width:38% ; margin-left: 32%; font-size: 14px;" placeholder="请填写公司全称或办事处" ></input>
        </div>
		<br>
		
		<!-- 联系人姓名 -->
		<div class="mdui-textfield mdui-textfield-floating-label">
			<i class="mdui-icon material-icons" style="font-size: 18px; margin-left: 12%; color: black;"><span style="color: red;">*</span>联系人姓名:</i>
		...
		<div class="mdui-textfield mdui-textfield-floating-label">
			...
			<input id="email" name="email" onchange="emailCheck()" class="mdui-textfield-input" style="width:38% ; margin-left: 32%; font-size: 14px;" placeholder="请输入邮箱地址" ></input>
		...
		<div class="mdui-textfield mdui-textfield-floating-label">
			...
			<input id="telephone" name="telephone" onchange="teleCheck()" class="mdui-textfield-input" style="width:38% ; margin-left: 32%; font-size: 14px;" placeholder="请输入联系人的电话" ></input>
		...
		<div style="margin-left: 12%;">
			<div style="float: left;">
				<p style="font-size: 22px;font-weight: 400; border: 2px solid #E0E0E0; background-color: #0097A1; color: #FFFFFF; border-radius: 17px; width: 30px; height: 30px; text-align: center;display: flex; align-items: center;justify-content: center;">2</p>
			</div>
			<div style="float: left;">
		...
		<div >
			<div id="x" class="control-label col-md-2 " style=" float: left; margin-left: 14%; width:25%">
				<a title="看不清图片？点击换一个" onclick="reloadValidateCode();">
					<img src="../validateCode" id="captcha_img" class="mdui-center mdui-shadow-1 mdui-hoverable " style=" height: 50px;" alt="验证码">
				</a>
			</div>
			<div class="mdui-textfield mdui-textfield-floating-label" style="float: left;width: 25%; margin-left: 6%;">
				<input id="verification" name="verification" type="text" class="mdui-textfield-input mdui-center" name="registerValidateCode" id="registerValidateCode" placeholder="输入验证码">
			</div>
		</div>
		<div style="clear:both; margin-top: 17%;">
			<input type="submit" onclick="regist()" class="mdui-btn mdui-btn-raised mdui-color-pink-accent mdui-ripple mdui-center" style="width:200px; font-size: 17px" value="确认注册" id = "registerButton" />
		</div>
		<br>
		<br>
		<a href="Enterprise/login" class="mdui-btn mdui-btn-raised mdui-color-light-blue-a700 mdui-ripple mdui-center" style="width:200px; font-size: 17px">前往登录</a>
		<br><br>
	</div>
	<br>
				...
				$.get("registerCheck",
						{
							...
							if(data.stateCode === "1"){
								mdui.snackbar({message: '注册成功',position: 'top', timeout: 1500});
								window.location.href = "/index";
							}
							else{
								mdui.snackbar({message: '注册失败',position: 'top', timeout: 1500});
							}
						}
				)
			}
