...
public class Tender {
    ...
    public Tender(Integer tId, String tTname, String tName, String tPhone, String tEmail, String tStartdate, String tTxt, String tInfo, String enPhone, String tEnddate, String sPhone, Integer tAddperson) {
        this.tId = tId;
        this.tTname = tTname;
        this.tName = tName;
        this.tPhone = tPhone;
